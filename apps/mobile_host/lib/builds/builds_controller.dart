...
/// Stable offline library owner when the user is signed out (DART-040/041 mobile).
const String kLocalLibraryMembershipId = 'local-library';

/// Draft synergy type for create UI (DART-041).
...
/// In-process orchestration for mobile Builds list + reduced-density compose
/// (DART-040/041).
///
/// Calls [destiny2_app] use cases against the host's single [AppDatabase].
