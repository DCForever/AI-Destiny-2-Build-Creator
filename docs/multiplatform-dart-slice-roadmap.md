...
**Updated:** 2026-07-25 (DART-053 done — inventory sync diagnostics UI; next DART-054 live parity harness)  
...
| Field | Value |
| ----- | ----- |
| **Next / active slice** | **DART-054** `inventory-live-parity-harness` (**planned** — next after DART-053 diagnostics UI) |
