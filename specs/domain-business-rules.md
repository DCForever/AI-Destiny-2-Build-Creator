...
| DBR-UI-007 | Weapon **detail** shows selected plugs, **can-roll** pool, and **possible crafted options** when craftable (when data exists). Do not invent pool/craft options. Set **slot rows** stay icon-only (no full perk grid). |
